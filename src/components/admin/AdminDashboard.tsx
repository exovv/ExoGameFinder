import { AlertTriangle, Database, Download, History, ImageOff, Upload, Wand2 } from "lucide-react";
import type { AuditLogEntry, Game } from "../../types/game";
...
export function AdminDashboard({ games, auditLog, onExport, onImport }: AdminDashboardProps) {
  ...
  return (
    <section className="admin-dashboard">
      <div className="stat-grid">
        ...
        <div className="stat-card highlight"><History aria-hidden="true" /><span>Modifications</span><strong>{auditLog.length}</strong></div>
      </div>
